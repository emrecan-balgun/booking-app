  ...
  return (
    <div className="container mx-auto mt-10">
        <div className="flex flex-row justify-between">
                <ul className="flex flex-col gap-2 text-xs tracking-tight text-blue-900">
                ...
                <ul className="flex flex-col gap-2 text-xs tracking-tight text-blue-900">
                    ...
                    <li><a href="#">Safetory Resource Center</a></li>
                    <li><a href="#">Investor relations</a></li>
                    <li><a href="#">Terms & conditions</a></li>
                </ul>
        </div>
        <span className="text-xs mb-1">Copyright © 2022 BE Booking.</span>
    </div>
  )
}
